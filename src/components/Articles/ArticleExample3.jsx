            ...
            <div className="card-body w-100 buyerssellersarticletextcontainer">
              ...
              <div className="card-text">
                <p className="card-text">
                  ...
                  owning a home can be a great investment, and it can provide ye
                  with a sense of stability and security that ye might not get
                  from a life on the high seas.
                  <br></br>
                  &nbsp; But before ye start lookin' for a home, ye need to
                  figure out what ye want and what ye can afford. Think about
                  what kind of ship - I mean, home - would suit yer needs. Do ye
                  need a big one to accommodate a crew of scallywags, or just a
                  small one for ye and yer parrot? Do ye want to be close to the
                  harbor, or do ye prefer a quieter spot on the outskirts of
                  town?
                  <br></br>
                  &nbsp; Once ye have a clear idea of what ye want, it's time to
                  set yer budget. Ye don't want to be spendin' all yer doubloons
                  on a fancy house, only to find out ye can't afford to repair
                  the leaks in yer own ship. Be realistic about what ye can
                  afford, and stick to it. And then, it's time to start
